                        ...
                        <div class="row dt-row">
                            <div class="col-sm-12">
                                <table class="table dataTable no-footer" id="table1" aria-describedby="table1_info">
                                    ...
                                    <tbody>
                                        @foreach ($laporan_saya as $key => $item)
                                            <tr class="{{ $key % 2 == 0 ? 'even' : 'odd' }}">
                                                ...
                                                <td>
                                                    <a href="{{ url('/pelapor/laporan_saya/' . $item->laporan_id) }}"
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-5">
                                <div class="dataTables_info" id="table1_info" role="status" aria-live="polite">
                                    {{-- Showing {{ $laporan_saya->firstItem() }} to {{ $laporan_saya->lastItem() }} of {{ $laporan_saya->total() }} entries --}}
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-7">
                                <div class="dataTables_paginate paging_simple_numbers" id="table1_paginate">
                                    {{-- {{ $laporan_saya->links('pagination::bootstrap-5') }} --}}
                                </div>
                            </div>
                        </div>
                    </div>
