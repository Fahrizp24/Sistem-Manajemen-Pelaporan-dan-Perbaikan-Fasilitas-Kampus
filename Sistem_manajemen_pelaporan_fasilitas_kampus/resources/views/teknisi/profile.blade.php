...
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="username" value="{{ $teknisi->username }}"
                                            disabled>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="tel" class="form-control" id="no_telp" name="no_telp"
                                            value="{{ $teknisi->no_telp ?? '-' }}" disabled>
                                    </div>
                    
                                    <div class="mb-3">
                                        <label for="email" class="form-label">Email</label>
                                        <input type="email" class="form-control" id="email" name="email"
                                            value="{{ $teknisi->email }}" required disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function uploadFoto() {
            ...
            fetch("{{ route('teknisi.updateFoto') }}", {
                method: 'POST',
                body: formData,
                headers: {
