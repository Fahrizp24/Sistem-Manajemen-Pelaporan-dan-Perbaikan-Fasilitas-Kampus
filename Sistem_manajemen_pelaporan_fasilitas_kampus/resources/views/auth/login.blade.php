...
.logo {
    ...
    object-fit: contain;
    max-width: 130px;           /* Atur lebar maksimal */
}

.login-title {
    text-align: center;        /* Tengah horizontal */
    font-size: 2rem;           /* Ukuran keseluruhan judul */
    margin-bottom: 1.5rem;
}

.login-title .thin-text {
    font-weight: 300;          /* Lebih tipis dari normal (400) */
    margin-right: 5px;         /* Jarak sedikit dari kata PROFIL */
}
