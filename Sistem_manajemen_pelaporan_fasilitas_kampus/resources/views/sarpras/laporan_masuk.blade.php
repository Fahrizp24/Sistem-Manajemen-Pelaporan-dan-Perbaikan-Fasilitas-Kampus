                        ...
                        <tbody>
                            @foreach ($fasilitas_memilih_teknisi as $item)
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-warning text-white">Perlu Penugasan</span>
                                    </td>
                                    <td class="text-center">
                                        <button onclick="showDetailModal('{{ url('sarpras/laporan_masuk/' . $item->fasilitas_id) }}?source=admin')"
                                            class="btn btn-sm btn-primary">
                                            <i class="bi bi-eye-fill me-1"></i> Detail
                                        </button>
                                    </td>
                        ...
                        <tbody>
                            @foreach ($fasilitas_telah_diperbaiki as $item)
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($item->updated_at)->format('d M Y') }}</td>
                                    <td>
                                        <span class="badge bg-info">Perlu Ditelaah</span>
                                    </td>
                                    <td class="text-center">
                                        <button onclick="showDetailModal('{{ url('sarpras/laporan_masuk/' . $item->fasilitas_id) }}?source=teknisi')"
                                            class="btn btn-sm btn-primary">
                                            <i class="bi bi-eye-fill me-1"></i> Detail
                                        </button>
                                    </td>
