                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nama" name="nama" value="{{ $sarpras->nama }}"
                                            required disabled>
                                    </div>

                                    <div class="mb-3">
                                        <label for="username" class="form-label">Username</label>
                                        <input type="text" class="form-control" id="username" value="{{ $sarpras->username }}"
                                            disabled>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="tel" class="form-control" id="no_telp" name="no_telp"
                                            value="{{ $sarpras->no_telp ?? '-' }}" disabled>
                                    </div>
                    
                                    <div class="mb-3">
                                        <label for="email" class="form-label">Email</label>
                                        <input type="email" class="form-control" id="email" name="email"
                                            value="{{ $sarpras->email }}" required disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 text-center mb-4">
                                        <div class="d-flex flex-column align-items-center">
                                           ...
                                           <div class="profile-photo-wrapper" style="display: inline-block; position: relative; width: 205px; height: 255px;">
                                                <div>
                                                    <img id="foto-profil" class="profile-user-img img-fluid"
                                                        src="{{ auth()->user()->foto_profil ? asset('storage/foto_profil/' . auth()->user()->foto_profil) : asset('storage/foto_profil/default.jpg') }}"
                                                        alt="User profile picture"
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="mb-3">
                                            <label for="no_telp" class="form-label">Nomor Telepon</label>
                                            <input type="tel" class="form-control" id="no_telp" name="no_telp"
                                                value="{{ $sarpras->no_telp ?? '-' }}">
                                        </div>
                    
                                        <div class="mb-3">
                                            <label for="email" class="form-label">Email</label>
                                            <input type="email" class="form-control" id="email" name="email"
                                                value="{{ $sarpras->email }}" required>
                                        </div>

                                        <div class="footer d-flex justify-content-end">
                                            <div class="col-md-3 mb-1">
                                                <button type="submit" class="btn btn-primary w-100"></i> Simpan Perubahan
                                                </button>
                                            </div>
                                        </div>
                                    </div>
