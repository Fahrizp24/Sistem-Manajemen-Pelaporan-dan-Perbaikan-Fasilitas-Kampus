        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                @if(in_array($peran, ['pelapor']))
                    ...
                    <li
                        class="sidebar-item {{ str_contains($currentUrl, '/pelapor/laporan') && !str_contains($currentUrl, '/pelapor/laporan_saya') ? 'active' : '' }}">
                ...
                @if($peran === 'admin')
                    ...
                    <li
                        class="sidebar-item {{ str_contains($currentUrl, '/admin/kelola_laporan') && !str_contains($currentUrl, '/admin/laporan_periodik') ? 'active' : '' }}">
                    ...
                    <li class="sidebar-title">Menu Kelola</li>
