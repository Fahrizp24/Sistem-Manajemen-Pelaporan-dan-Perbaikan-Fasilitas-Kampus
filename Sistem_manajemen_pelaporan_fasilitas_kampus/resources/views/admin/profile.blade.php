                ...
                <form action="{{ route('admin.updateProfile') }}" method="POST">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div>
                                <input type="text" class="form-control bg-light-primary" id="username" value="{{ $admin->peran }}"
                                        disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="prodi" name="prodi" value="{{ $admin->prodi ?? '' }}" disabled>
                        </div>
                        <div class="col-md-6">
                            <label for="jurusan" class="form-label">Jurusan</label>
                            <input type="text" class="form-control" id="jurusan" name="jurusan" value="{{ $admin->jurusan ?? '' }}" disabled>
                        </div>
                    </div>
