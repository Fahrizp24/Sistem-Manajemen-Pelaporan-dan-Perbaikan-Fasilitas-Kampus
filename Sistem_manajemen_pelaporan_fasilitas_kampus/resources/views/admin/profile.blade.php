                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div>
                                        <span class="badge bg-primary py-2 px-3 divider">{{ $admin->peran }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="prodi" name="prodi" value="{{ $admin->prodi ?? '' }}">
                                </div>
                                <div class="col-md-6">
                                    <label for="jurusan" class="form-label">Jurusan</label>
                                    <input type="text" class="form-control" id="jurusan" name="jurusan" value="{{ $admin->jurusan ?? '' }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="tel" class="form-control" id="no_telp" name="no_telp" value="{{ $admin->no_telp ?? '' }}">
                                </div>
                                <div class="col-md-6">
...
<div class="modal fade" id="changeFotoModal" tabindex="-1" aria-labelledby="changeFotoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.updateFoto') }}" method="POST" id="form-upload" enctype="multipart/form-data">
                @csrf
